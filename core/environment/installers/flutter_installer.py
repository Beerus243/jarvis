...
class FlutterInstaller(EnvironmentInstaller):
    ...
    def plan_existing(self):
        return InstallationPlan('flutter',[InstallationStep('flutter-path','flutter','CONFIGURE_PATH',1,[],risk_level='MEDIUM'),InstallationStep('flutter-verify','flutter','VERIFY_FLUTTER',2,['flutter-path'],risk_level='LOW',requires_confirmation=False),InstallationStep('dart-verify','dart','VERIFY_DART',3,['flutter-verify'],risk_level='LOW',requires_confirmation=False)])
