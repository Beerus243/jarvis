...
def validate_source(source:TrustedSource, allowed_hosts=('storage.googleapis.com','nodejs.org','download.oracle.com','api.adoptium.net','adoptium.net','github.com','githubusercontent.com')):
