...
from core.intent import detect_intent, detect_work_environment_intent
...
def analyze(message, context=None):
    ...
    # ========================================================
    #
    # Cette détection doit avoir priorité sur parse_actions().
    #
    # Exemple :
    #
    # "mets-moi en condition pour travailler"
    #
    # pourrait être interprété par le parseur musical comme :
    #
    # PLAY_MUSIC
    #
    # alors qu'il s'agit clairement d'une demande de préparation
    # de l'environnement de travail.
    # ========================================================

    work_environment_intent = detect_work_environment_intent(message)

    if work_environment_intent:
        return _decision(
            "TASK",
            "CREATE",
            0.99,
