...
def plan(decision):
    ...
    if decision_type in {"ACTION", "ACTION_COMPOSED", "PERSONAL_MEMORY", "PERSONAL_STATE", "PROJECT_MEMORY", "PC_CONTEXT", "TASK"}:
    ...
    return {
        ...
        "requires_memory": source in {"PERSONAL_MEMORY", "PERSONAL_STATE", "PROJECT_MEMORY", "PC_CONTEXT", "TASK", "CONTEXT", "SEMANTIC_MEMORY"},
