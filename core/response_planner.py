...
def plan(decision):
    ...
    if decision_type in {"ACTION", "PERSONAL_MEMORY", "PERSONAL_STATE", "PROJECT_MEMORY"}:
    ...
    return {
        ...
        "requires_memory": source in {"PERSONAL_MEMORY", "PERSONAL_STATE", "PROJECT_MEMORY", "CONTEXT", "SEMANTIC_MEMORY"},
